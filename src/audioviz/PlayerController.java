...
//        String test = duration.toString().split(" ")[0];
//        float test2 = Float.valueOf(test);
//        String test3 = String.format("%.1f", test2).concat(" ms");
//        lengthText.setText(test3);
//      I just felt like converting this into 1 line of WHATISGOINGONHERE?!?

        lengthText.setText(String.format("%.1f", Float.valueOf(duration.toString().split(" ")[0])).concat(" ms"));

//      Rewriting cuz its an ugly abbreviation
//        Duration ct = mediaPlayer.getCurrentTime();
//        currentText.setText(ct.toString());
        Duration currentTime = mediaPlayer.getCurrentTime();
        currentText.setText(String.format("%.1f", Float.valueOf(currentTime.toString().split(" ")[0])).concat(" ms"));
//      haha jokes on me, cuz i wasted 5 minutes figuring out why this isnt updating. These 2 lines of code were already useless to begin with before I played with em
        currentVisualizer.start(numBands, vizPane);
        timeSlider.setMin(0);
...
// TO DO: Handle update with slider by moving slider to position and convert position to fraction, set slider to nearest tenth of a milisecond after dropping, and set current play time to that millisecond
